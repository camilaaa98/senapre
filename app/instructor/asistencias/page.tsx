...
export default function AsistenciasInstructorPage() {
    ...
    <DashboardLayout role="instructor" userName="Instructor SENA">
      <div className="space-y-6 animate-slide-in">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Revisa el historial de asistencias</p>
        </div>

        <Card className="shadow-lg border-border/50">
          <CardHeader>
            <CardTitle>Filtros de Búsqueda</CardTitle>
            <CardDescription>Selecciona la ficha y fecha</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                <Label htmlFor="ficha-consulta">Número de Ficha</Label>
                <Input
                  id="ficha-consulta"
                  value={selectedFicha}
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Ficha {selectedFicha} - {new Date(selectedDate).toLocaleDateString('es-ES', { dateStyle: 'long' })}
                </CardDescription>
              </div>
